...
from . import (index, login, register, admin_home, user_home, users, logout, home, workout)
from . import (index, login, register, admin_home, user_home, users, logout, home, water, sleep, steps, weight, dashboard)